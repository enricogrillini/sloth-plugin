  ...
  public static void writeAddFields(StringBuilder stringBuilder, List<Element> elements) {
    for (Element element : elements) {
      if (element instanceof TextTotalizer) {
        ...
        stringBuilder
            .append("      addChild(" + StringUtil.toJavaObjectName(button.getName()) + " = new Button(" + "_")
            .append(StringUtil.toJavaConstantName(button.getName()) + ", ")
            .append((button.getDescription() == null ? "null" : " \"" + button.getDescription() + "\"") + ", ")
            .append((button.getTooltip() == null ? "null" : " \"" + button.getTooltip() + "\"") + ", ")
            .append(button.isHidden() + ", ")
            .append(button.isDisabled() + ", ")
            .append((button.getType() == null ? "null" : "ButtonType." + button.getType()) + ", ")
            .append("\"" + StringUtil.replace(button.getImgHtml(), "\"", "\\\"") + "\"" + "));\n");
