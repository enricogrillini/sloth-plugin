...
public class ElementFactory {
    ...
    public static String getListGenerics(DataType dataType) {
        ...
        } else if (DataType.DECIMAL.equals(dataType) || DataType.INTEGER.equals(dataType) || DataType.CURRENCY.equals(dataType) || DataType.CURRENCY_INTEGER.equals(dataType)  || DataType.PERC.equals(dataType) || DataType.NUMBER.equals(dataType)) {
    ...
    public static String getGenerics(DataType dataType) {
        ...
        if (DataType.DATE.equals(dataType) || DataType.DATETIME.equals(dataType) || DataType.TIME.equals(dataType) || DataType.HOUR.equals(dataType) || DataType.MONTH.equals(dataType)) {
            return "<Timestamp>";
        } else if (DataType.NUMBER.equals(dataType) || DataType.DECIMAL.equals(dataType) || DataType.INTEGER.equals(dataType) || DataType.CURRENCY.equals(dataType) || DataType.CURRENCY_INTEGER.equals(dataType) || DataType.PERC.equals(dataType)) {
            return "<BigDecimal>";
